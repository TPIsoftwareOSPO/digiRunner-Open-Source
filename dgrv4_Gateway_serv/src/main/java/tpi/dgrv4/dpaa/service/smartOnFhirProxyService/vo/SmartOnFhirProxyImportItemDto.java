...
/**
 * Smart on FHIR Proxy 單筆匯入資料格式
 * 包含 UUID 欄位供請求方追蹤處理結果（可選）
 */
public class SmartOnFhirProxyImportItemDto {

    // UUID（可選，由請求方傳入，系統原樣回傳；若不傳入則為 null）
    private String uuid;
    ...
    private ImportValidationResultDto validationResult; // 驗證結果

    public ImportValidationResultDto getValidationResult() {
        return validationResult;
    }

    public void setValidationResult(ImportValidationResultDto validationResult) {
    ...
    public String toString() {
        return "SmartOnFhirProxyImportItemDto [uuid=" + uuid + ", sofProxyId=" + sofProxyId + ", sofProxyName="
                + sofProxyName + ", sofProxyStatus=" + sofProxyStatus + ", sofProxyRemark=" + sofProxyRemark
                ...
                + ", sofProxyUrlRewrite=" + sofProxyUrlRewrite + ", sofProxyTps=" + sofProxyTps + ", sofProxyIgnoreApi=" + sofProxyIgnoreApi
