...
import {
  ResDPB0032,
  ReqDPB0032,
} from 'src/app/models/api/AboutService/dpb0032.interface';
import { TxID } from 'src/app/models/common.enum';
import {
  DPB0031Req,
  ResDPB0031,
  ReqDPB0031,
} from 'src/app/models/api/AboutService/dpb0031.interface';
import {
  DPB0118Resp,
  ResDPB0118,
} from 'src/app/models/api/AboutService/dpb0118.interface';
...
export class AboutService {
  ...
  checkLicenseExpired(): Observable<boolean> {
    return this.queryModuleVersion().pipe(
      map((res) => {
        return res.RespBody.isExpired;
      }),
    );
  }
}
