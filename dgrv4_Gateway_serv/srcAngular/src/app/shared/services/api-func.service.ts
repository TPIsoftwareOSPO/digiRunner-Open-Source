...
import {
  ...
  ResAA0104,
  ReqAA0104,
} from '../../models/api/FuncService/aa0104.interface';
import {
  AA0103Req,
  ResAA0103,
  ReqAA0103,
} from '../../models/api/FuncService/aa0103.interface';
import {
  AA0102Req,
  ResAA0102,
  ReqAA0102,
} from '../../models/api/FuncService/aa0102.interface';
import {
  ResAA0101,
  ReqAA0101,
} from '../../models/api/FuncService/aa0101.interface';
...
import {
  ...
  ReqAA0107,
  ResAA0107,
} from 'src/app/models/api/FuncService/aa0107.interface';
import {
  AA0108Req,
  ReqAA0108,
  ResAA0108,
} from 'src/app/models/api/FuncService/aa0108.interface';
