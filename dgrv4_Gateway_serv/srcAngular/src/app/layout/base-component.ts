...
export class BaseComponent {
    ...
    public getControls(frmGrp: UntypedFormGroup, key: string) {
    ...
    public addFormValidator(form: UntypedFormGroup, validators: Array<ValidatorFormat>) {
        try {
            validators.map(item => {
    ...
    public resetFormValidator(form: UntypedFormGroup,formReset = true) {
