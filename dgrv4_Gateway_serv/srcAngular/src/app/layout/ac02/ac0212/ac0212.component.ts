...
import {
  AA1115GroupAuthorities,
  AA1115Req,
} from 'src/app/models/api/GroupAuthService/aa1115.interface';
...
export class Ac0212Component extends BaseComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.cols = [
      ...
      {
        field: 'groupName',
        header: `${dict['group_name']}(${dict['alias']})`,
        width: '20%',
      },
      { field: 'groupDesc', header: dict['group_desc'], width: '20%' },
      {
        field: 'groupAuthorities',
        header: dict['authorities'] + '(v3)',
        width: '20%',
      },
      {
        field: 'securityLevelName',
        header: dict['security_level'],
        width: '10%',
      },
    ...
    this.colsAuthorities = [
      {
        field: 'groupAuthoritiesId',
        header: dict['group_auth_id'],
        width: '20%',
      },
      {
        field: 'groupAuthoritiesName',
        header: `${dict['group_auth_name']}`,
        width: '30%',
      },
      {
        field: 'groupAuthoritiesDesc',
        header: dict['group_auth_desc'],
        width: '50%',
      },
    ];
    this.colsModuleList = [
    ...
    this.clientService
      .queryGroupList_0238_ignore1298(ReqBody)
      .subscribe((res) => {
        if (this.tool.checkDpSuccess(res.ResHeader)) {
  ...
  queryauthorities_page4() {
    ...
    this.groupAuthService.queryScopeAuthorities(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        this.rowcount_Authorities_page4 =
          res.RespBody.groupAuthoritiesList.length;
      ...
      case FormOperate.detail:
        this.clientService.queryGroupDetail(req_0213).subscribe((res) => {
          if (this.tool.checkDpSuccess(res.ResHeader)) {
            ...
            this.clientService
              .queryModule_0235(ReqBody)
              .subscribe(async (res_0235) => {
                if (this.tool.checkDpSuccess(res_0235.ResHeader)) {
                  ...
                  if (res.RespBody.approximateTimeUnit == '') {
                    _allowAccessDays_str =
                      res.RespBody.allowAccessDays +
                      res.RespBody['timeUnitName'];
                  } else {
                    _allowAccessDays_str =
                      res.RespBody.allowAccessDays +
                      res.RespBody['timeUnitName'] +
                      `(${res.RespBody.approximateTimeUnit})`;
                  }
                  this.form_page3.patchValue({
                    ...
                    securityLevelName:
                      res.RespBody.securityLevel.securityLevelName,
                    ...
                    groupAuthoritiesName: this.transformGroupAuthorities(
                      res.RespBody.groupAuthorities,
                    ),
                  });
      ...
      case FormOperate.update:
        ...
        this.clientService.queryGroupDetail(req_0213).subscribe((res) => {
          if (this.tool.checkDpSuccess(res.ResHeader)) {
            ...
            this.list
              .querySubItemsByItemNo(ReqBody)
              .subscribe((res_DPB0047) => {
                if (this.toolService.checkDpSuccess(res_DPB0047.ResHeader)) {
                  ...
                  this.clientService
                    .queryModule_0235(ReqBody_0235)
                    .subscribe(async (res_0235) => {
                      if (this.tool.checkDpSuccess(res_0235.ResHeader)) {
                        this.clientService
                          .updateGroup_before()
                          .subscribe((res_updateGroup_before) => {
                            if (
                              this.tool.checkDpSuccess(
                                res_updateGroup_before.ResHeader,
                              )
                            ) {
                              res_updateGroup_before.RespBody['constraints'][1][
                                'field'
                              ] = 'groupName_page4';
                              res_updateGroup_before.RespBody['constraints'][2][
                                'field'
                              ] = 'groupAlias_page4';
                              res_updateGroup_before.RespBody['constraints'][3][
                                'field'
                              ] = 'allowAccessDays_page4';
                              res_updateGroup_before.RespBody['constraints'][4][
                                'field'
                              ] = 'dayOptionsName_page4';
                              res_updateGroup_before.RespBody['constraints'][5][
                                'field'
                              ] = 'allowAccessUseTimes_page4';
                              res_updateGroup_before.RespBody['constraints'][6][
                                'field'
                              ] = 'groupDesc_page4';
                              res_updateGroup_before.RespBody['constraints'][7][
                                'field'
                              ] = 'securityLevelName_page4';
                              this.addFormValidator(
                                this.form_page4,
                                res_updateGroup_before.RespBody['constraints'],
                              );
                              let data_0235: any[] = [];
                              res_0235.RespBody.moduleList.forEach(
                                (element) => {
                                  let single_data = {};
                                  let apilist = '';
                                  element['apiList'].forEach((api_element) => {
                                    if (api_element['apiName']) {
                                      apilist +=
                                        `${api_element['apiKey']}(${api_element['apiName']})` +
                                        '、';
                                    } else {
                                      apilist +=
                                        `${api_element['apiKey']}()` + '、';
                                  ...
                                  single_data['label'] = element['moduleName'];
                                  single_data['value'] = element;
                                  single_data['apilist'] = apilist.slice(
                                    0,
                                    apilist.length - 1,
                                  );
                                  data_0235.push(single_data);
                              ...
                              this.orimoduleList = JSON.stringify(
                                res_0235.RespBody.moduleList,
                              );
                              this.form_page4.patchValue({
                                ...
                                groupAccess: res.RespBody.groupAccess,
                                securityLevelName_page4:
                                  res.RespBody.securityLevel.securityLevelId,
                                allowAccessDays_page4:
                                  res.RespBody.allowAccessDays,
                                allowAccessUseTimes_page4:
                                  res.RespBody.allowAccessUseTimes,
                                createDate: res.RespBody.createDate,
                                createUser: res.RespBody.createUser,
                                updateDate: res.RespBody.updateDate,
                                updateUser: res.RespBody.updateUser,
                                dayOptionsName_page4: res.RespBody.timeUnit,
                                groupAuthoritiesName:
                                  this.transformGroupAuthorities(
                                    res.RespBody.groupAuthorities,
                                  ),
                              });
            ...
            this.clientService
              ...
              .subscribe(async (res_0235) => {
                if (this.tool.checkDpSuccess(res_0235.ResHeader)) {
                  ...
                  var _allowAccessDays_str = '';
                  if (res.RespBody.approximateTimeUnit == '') {
                    _allowAccessDays_str = await this.convertTimes(
                      res.RespBody.allowAccessDays,
                    );
                  } else {
                    _allowAccessDays_str =
                      (await this.convertTimes(res.RespBody.allowAccessDays)) +
                      `(${res.RespBody.approximateTimeUnit})`;
                  }
  ...
  call_0234() {
    ...
    this.clientService.queryapi_0234(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        ...
        this.last_api_page6 =
          res.RespBody['apiList'][res.RespBody['apiList'].length - 1]['apiKey'];
  ...
  Select_API(Data: Object[]) {
    ...
    this.none_choose_api_list.splice(
      this.none_choose_api_list.indexOf(Data),
      1,
    );
    this.rowcount_page6 = this.none_choose_api_list.length;
  }
  Unselect_API(Data: Object[]) {
    if (!this.none_choose_api_list) this.none_choose_api_list = [];
    this.none_choose_api_list.push(Data);
    this.been_choose_api_list.splice(
      this.been_choose_api_list.indexOf(Data),
      1,
    );
    this.rowcount_page6 = this.none_choose_api_list.length;
  }
  moreData_page6() {
    ...
    this.clientService.queryapi_0234(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        this.none_choose_api_list = this.none_choose_api_list.concat(
          res.RespBody['apiList'],
        );
        this.last_api_page6 =
          res.RespBody['apiList'][res.RespBody['apiList'].length - 1]['apiKey'];
        this.rowcount_page6 = this.none_choose_api_list.length;
  ...
  async save_choose_API() {
    ...
    this.data_0235_page4?.forEach((item) => {
      if (item.label == this.form_page6.get('moduleName')!.value) {
        ...
        if (apilist != '') apilist = apilist.slice(0, apilist.length - 1);
  ...
  call_0233() {
    ...
    this.clientService.queryModule_0233(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        ...
        this.last_module_page7 =
          res.RespBody.moduleNameList[
            res.RespBody['moduleNameList'].length - 1
          ];
  ...
  Select_Module(Data: Object[]) {
    ...
    this.none_choose_module_list.splice(
      this.none_choose_module_list.indexOf(Data),
      1,
    );
    this.rowcount_page7 = this.none_choose_module_list.length;
  }
  Unselect_Module(Data: Object[]) {
    ...
    this.been_choose_module_list.splice(
      this.been_choose_module_list.indexOf(Data),
      1,
    );
    this.rowcount_page7 = this.none_choose_module_list.length;
  }
  ...
  moreData_page7() {
    ...
    this.clientService.queryModule_0233(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        ...
        this.none_choose_module_list = this.none_choose_module_list.concat(
          UnselectedModuleKeyList,
        );
        this.last_module_page7 =
          res.RespBody.moduleNameList[
            res.RespBody['moduleNameList'].length - 1
        ...
        for (var i = 0; i < this.data_0235_page4.length; i++) {
          ...
          if (i == this.data_0235_page4.length - 1) {
            temp_data.push({
              ...
              value: { apiList: [], moduleName: item.moduleName },
              apilist: '',
            });
          }
        }
  ...
  async submitForm_page4() {
    ...
    this.data_0235_page4?.forEach((item) => {
      if (item['apilist'] != '') {
        ...
        ApiList.push({
          moduleName: item['value']['moduleName'],
          apiKeyList: arr,
        });
      }
      // else{
    ...
    let ReqBody = {
      ...
      allowDaysUnit: this.translatetime(
        this.form_page4.get('dayOptionsName_page4')!.value,
      ),
    ...
    this.clientService.updateGroup(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        this.messageService.add({
          severity: 'success',
          summary: `${dict['message.update']} ${dict['message.group']}`,
  ...
  translatetime(select) {
    ...
    if (select == 'd') {
      str =
        this.toolService.Base64Encoder(this.toolService.BcryptEncoder(select)) +
        ',' +
        3;
    } else if (select == 'H') {
      str =
  ...
  Select_Module_page11(Data: Object[]) {
    ...
    this.none_choose_module_list_page11.splice(
      this.none_choose_module_list_page11.indexOf(Data),
      1,
    );
    this.rowcount_page11 = this.none_choose_module_list_page11.length;
  }
  Unselect_Module_page11(Data: Object[]) {
    ...
    this.been_choose_module_list_page11.splice(
      this.been_choose_module_list_page11.indexOf(Data),
      1,
    );
    this.rowcount_page11 = this.none_choose_module_list_page11.length;
  }
  ...
  moreData_page11() {
    ...
    this.clientService.queryModule_0233(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        ...
        this.none_choose_module_list_page11 =
          this.none_choose_module_list_page11.concat(UnselectedModuleKeyList);
        this.last_module_page11 =
          res.RespBody.moduleNameList[
            res.RespBody['moduleNameList'].length - 1
          ];
  ...
  Select_API_page12(Data: Object[]) {
    ...
    this.none_choose_api_list_page12.splice(
      this.none_choose_api_list_page12.indexOf(Data),
      1,
    );
    this.rowcount_page12 = this.none_choose_api_list_page12.length;
  }
  Unselect_API_page12(Data: Object[]) {
    ...
    this.been_choose_api_list_page12.splice(
      this.been_choose_api_list_page12.indexOf(Data),
      1,
    );
    this.rowcount_page12 = this.none_choose_api_list_page12.length;
  }
  ...
  moreData_page12() {
    ...
    this.clientService.queryapi_0234(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        this.none_choose_api_list_page12 =
          this.none_choose_api_list_page12.concat(res.RespBody['apiList']);
        this.last_api_page12 =
          res.RespBody['apiList'][res.RespBody['apiList'].length - 1]['apiKey'];
        this.rowcount_page12 = this.none_choose_api_list_page12.length;
      }
  ...
  queryauthorities_page9() {
    ...
    this.groupAuthService.queryScopeAuthorities(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        this.rowcount_Authorities_page9 =
          res.RespBody.groupAuthoritiesList.length;
  ...
  async submitForm_page9() {
    ...
    let ReqBody = {
      ...
      allowAccessUseTimesTimeUnit: this.translatetime(
        this.form_page9.get('dayOptionsName')!.value,
      ),
    ...
    this.clientService.addGroup(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        ...
        this.messageService.add({
          severity: 'success',
          summary: `${dict['message.create']} ${dict['message.group']}`,
  ...
  async delete_group() {
    ...
    this.clientService.deleteGroup(ReqBody).subscribe((res) => {
      if (this.tool.checkDpSuccess(res.ResHeader)) {
        this.messageService.add({
          severity: 'success',
          summary: `${dict['message.delete']} ${dict['message.group']}`,
  ...
  public get groupName_page9() {
    return this.form_page9.get('groupName_page9');
  }
  public get groupAlias_page9() {
    return this.form_page9.get('groupAlias_page9');
  }
  public get allowAccessDays() {
    return this.form_page9.get('allowAccessDays');
  }
  public get allowAccessUseTimes() {
    return this.form_page9.get('allowAccessUseTimes');
  }
  public get securityLevelName() {
    return this.form_page9.get('securityLevelName');
  }
  public get groupDesc() {
    return this.form_page9.get('groupDesc');
  }
  public get dayOptionsName() {
    return this.form_page9.get('dayOptionsName');
  }

  public get groupName_page4() {
    return this.form_page4.get('groupName_page4');
  }
  public get groupAlias_page4() {
    return this.form_page4.get('groupAlias_page4');
  }
  public get allowAccessDays_page4() {
    return this.form_page4.get('allowAccessDays_page4');
  }
  public get allowAccessUseTimes_page4() {
    return this.form_page4.get('allowAccessUseTimes_page4');
  }
  public get securityLevelName_page4() {
    return this.form_page4.get('securityLevelName_page4');
  }
  public get groupDesc_page4() {
    return this.form_page4.get('groupDesc_page4');
  }
  public get dayOptionsName_page4() {
    return this.form_page4.get('dayOptionsName_page4');
  }
  public get groupID() {
    return this.form_page4.get('groupID');
  }
}
