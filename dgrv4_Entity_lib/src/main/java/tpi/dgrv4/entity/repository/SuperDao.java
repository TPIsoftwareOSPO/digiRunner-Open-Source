...
public interface SuperDao<T> {
	...
	/**
	 * Saves all given entities and retry when primary key is duplicated.
	 * Use the returned instances for further operations as the save operation might have changed the
	 * entity instances completely.
	 *
