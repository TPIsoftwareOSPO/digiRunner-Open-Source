...
public class TsmpFuncTableInitializer {
	...
	public List<TsmpFuncVo> insertTsmpFunc(LicenseEditionTypeVo licenseEdition, boolean isOsType) {
		try {
	        ...
	        createTsmpFunc("AC00","AC User Management","AC User Management","AC User Management",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC00","AC 權限管理","AC01","使用者管理",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0002","Users","User Maintenance","User Maintenance",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0002","使用者維護","Query User","使用者功能查詢, 資料更新",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0006","My Profile","","Update User Profile",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0006","個人資料維護","Update User Profile","個人資料維護",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0012","Roles","Role Management","Role Management",null,"en-US","manager",DateTimeUtil.now());
	    	...
	    	createTsmpFunc("AC01","Development Mode","","Enable development mode with streamlined function management to accelerate feature iteration and system optimization.",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC01","系統功能管理","Function Management","系統功能管理",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0101","Function Management","","Comprehensive function management and maintenance to ensure system stability and continuous optimization.",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0101","功能維護","Query Function","功能維護",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0103","Rtn Code Management","Rtn Code Management","Centralized return code management to ensure consistent system responses and efficient maintenance.","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0103","回傳碼維護","Rtn Code Management","回傳碼維護","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0104","Index Management","Index Management","Index Management",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0104","Index管理","Index Management","Index管理",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC02","Client Management","Client Management","Client Management",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC02","用戶端管理","Client Management","用戶端管理",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0202","API Client","Client Management","Manage clients with ease—supporting intuitive queries and instant updates directly from the user interface.",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0202","用戶端維護","Query Client","用戶端查詢",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0212","API Group","Group Management","Easily manage groups with intuitive search tools and instant update features.",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0212","群組維護","Query Group","群組查詢",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0222","API Scope","VGroup Management","Simplify virtual group handling with easy-to-use query tools and seamless update functions.","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0222","授權範圍維護","queryVGroupList","查詢VGroupList","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC03","API Management","","API Management",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC03","API管理","API Management","API管理",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0301","API List","","API LIST",null,"en-US","manager",DateTimeUtil.now());
	    	...
	    	createTsmpFunc("AC0316","API Test","","API TEST",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0316","API測試區","API TEST","API測試區",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0318","API List-Import API","","API List-Import API",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0318","API列表-匯入註冊/組合API","API List-Import API","",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC05","Monitor & Alert","","Monitor & Alert",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC05","監控管理","Monitor","監控管理",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0501","digiRunner Server","","digiRunnerMonitor",null,"en-US","manager",DateTimeUtil.now());
	    	...
	    	if (isOsType == false) {
	    		createTsmpFunc("AC0509","Security Audit Log","Security Audit Log","Security Audit Log",null,"en-US","manager",DateTimeUtil.now());
	    	...
	    	createTsmpFunc("AC09","Reports","","Reports Management",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC09","報表管理","Reports","報表管理",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0901","API Calls","","API Usage Report",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0901","API使用次數統計","API Usage Report","API使用次數統計",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0902","API RESP distribution","","API RESP distribution",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0902","API回應時間分佈","API RESP distribution","API回應時間分佈",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0903","API Avg. RESP Time","","API Avg. RESP Time",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0903","API平均回應時間","API Avg. RESP Time","API平均回應時間",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0904","API RPM/RPS","","API Text Search",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0904","API請求/回覆明細查詢","API Text Search","API請求/回覆明細查詢",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0905","API GTW Traffic","","API Traffic Analysis",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0905","API GTW 流量分佈","API Traffic Analysis","API流量分析",null,"zh-TW","manager",DateTimeUtil.now());
	        createTsmpFunc("AC0906","Bad Attempts","","Bad Attempt Report",null,"en-US","manager",DateTimeUtil.now());
	        createTsmpFunc("AC0906","Bad Attempt連線報告","Bad Attempt Report","Bad Attempt連線報告",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0907","Client Calls","","Clients Usage Report",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0907","Clients使用次數統計","Clients Usage Report","Clients使用次數統計",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0908","Client - API Calls","","Client-API Usage Report",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0908","Client-API使用次數統計","Client-API Usage Report","Client-API使用次數統計",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0909","API GTW Integrity","","API GTW Integrity",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0909","API GTW 存取統計","API GTW Integrity","API GTW 存取統計",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0910","API RESP elapse","API RESP elapse","API RESP elapse",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC0910","API 回應時間極值","API RESP elapse","API 極值時間分析",null,"zh-TW","manager",DateTimeUtil.now());
	    	
	    	createTsmpFunc("AC1002","Organization","","Organization","","en-US","manager",DateTimeUtil.now());
	    	...
	    	createTsmpFunc("AC1116","Security Level","Security Level Management","Security Level Management","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1116","安全等級維護","Security Level Management","安全等級維護","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1202","Role & txID","Role txId mapping","Role txId mapping","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1202","角色與交易代碼對應","Role txId mapping","角色與交易代碼對應","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC13","Reports","Reports","Reports","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC13","報表管理","Reports","報表管理","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1301","API Calls","API Usage Report","API Usage Report","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1301","API使用次數統計","API Usage Report","API使用次數統計","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1302","API RESP distribution","API RESP distribution","API RESP distribution","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1302","API回應時間分佈","API RESP distribution","API回應時間分佈","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1303","API Avg. RESP Time","API Avg. RESP Time","API Avg. RESP Time","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1303","API平均回應時間","API Avg. RESP Time","API平均回應時間","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1304","API GTW traffic","API GTW traffic","API GTW traffic","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("AC1304","API GTW流量分佈","API GTW traffic","API GTW流量分佈","","zh-TW","manager",DateTimeUtil.now());
            createTsmpFunc("AC1305","Bad Attempt Report","Bad Attempt Report","Bad Attempt Report","","en-US","manager",DateTimeUtil.now());
            createTsmpFunc("AC1305","Bad Attempt連線報告","Bad Attempt Report","Bad Attempt連線報告","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP01","API Portal Management","Web Portal","Web Portal",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP01","入口網後台管理","Web Portal","用於維護入口網",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0105","API Theme","API Theme","API Theme",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0105","主題分類維護","Theme Category","主題分類維護管理",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0113","FAQ","FAQ","FAQ",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0113","常見問答維護","常見問答維護","常見問答維護&編輯",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0114","About Us","About us","About us",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0114","關於網站維護","關於網站維護","關於網站維護&編輯",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0115","Sitemap","Sitemap","Sitemap",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0115","網站地圖維護","網站地圖維護","網站地圖維護&編輯",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0116","News","Announcement","Announcement",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0116","公告維護","Announcement","公告CRUD",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP02","Certificate Management","Client Certificate Authority","Client Certificate Authority",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP02","用戶憑證管理","Client Certificate Authority","用戶憑證管理",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0201","JWE Cert. List","JWE Certificate Authority List","JWE Certificate Authority List",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0201","JWE加密憑證列表","JWE Certificate Authority List","JWE加密憑證列表",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0202","JWE Cert. Management","JWE Certificate Authority Management","JWE Certificate Authority Managemen",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0202","JWE加密憑證維護","JWE Certificate Authority Management","JWE加密憑證維護",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0203","TLS Cert. List","TLS Communication Certificate List","TLS Communication Certificate List","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0203","TLS通訊憑證列表","TLS Communication Certificate List","TLS通訊憑證列表","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0204","TLS Cert. Management","TLS Communication Certificate Management","TLS Communication Certificate Management","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0204","TLS通訊憑證維護","TLS Communication Certificate Management","TLS Communication Certificate Management","","zh-TW","manager",DateTimeUtil.now());
			createTsmpFunc("NP0205","Client Certificates(mTLS)","Client Certificates(mTLS)","Client Certificates(mTLS)","","en-US","manager",DateTimeUtil.now());
			createTsmpFunc("NP0205","用戶端憑證(mTLS)","mTLS Client Management","用戶端憑證(mTLS)","","zh-TW","manager",DateTimeUtil.now());
			createTsmpFunc("NP03","Application Forms","Application Form","Application Form","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP03","各類申請單","Application Form","各類申請單","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0301","API Publish","API Shelves","API Shelves",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0301","API上下架","API Shelves","API上下架、異動",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0302","API Client Account","Client Registered Requisition","Client Registered Requisition","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0302","用戶端註冊","Client Registered Requisition","用戶端註冊","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0303","API Authorization","Client API Authorization Requisition","Client API Authorization Requisition","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0303","用戶端授權API","Client API Authorization Requisition","用戶端授權API","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0304","API Key","Apply an API Key","Apply an API Key","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0304","API Key 申請","Apply an API Key","API Key 申請","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0401","Applications","Applications","Applications",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0401","簽核作業","Applications","簽核作業",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0402","Approval Flow Settings","Sign Off Setting","Sign Off Setting",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0402","簽核關卡維護","Sign Off Setting","簽核關卡設定維護",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP05","System Information","System Information","System Information","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP05","系統現況查詢","System Information","系統現況查詢","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0504","API Key Approval History","API Key Approval History","API Key Approval History","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0504","API Key 現況查詢","API Key Approval History","API Key 現況查詢","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0512","Published API","API Shelves Search","API Shelves Search",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0512","入口網上架現況查詢","API Shelves Search","查詢入口網API上架現況",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0513","Scheduled Tasks","Schedule","Schedule",null,"en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0513","排程作業","Schedule","排程作業",null,"zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0514","Recurring Tasks","Cycle Schedule Job","Cycle Schedule Job","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0514","週期排程作業","Cycle Schedule Job","週期排程作業","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0516","Mail Log","Mail Log","Mail Log","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP0516","寄件歷程","Mail Log","寄件歷程","","zh-TW","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP1201","Swagger Settings","Swagger Settings","Swagger Settings","","en-US","manager",DateTimeUtil.now());
	    	createTsmpFunc("NP1201","Swagger開放設定","Switch On/Off","Swagger開放設定","","zh-TW","manager",DateTimeUtil.now());
			...
			createTsmpFunc("AC0320","gRPC Proxy","gRPC Proxy","gRPCProxy","","zh-TW","manager",DateTimeUtil.now());
			createTsmpFunc("AC0320","gRPC Proxy","gRPC Proxy","gRPCProxy","","en-US","manager",DateTimeUtil.now());
	...
	private List<TsmpFuncVo> getAlpha() {
		return tsmpFuncList.stream().filter(this::isInAlphaList).collect(Collectors.toList());
	}
	
	private List<TsmpFuncVo> getEnterprise() {
		return tsmpFuncList.stream().filter(this::isInEnterpriseList).collect(Collectors.toList());
	}

	private List<TsmpFuncVo> getEnterpriseLite() {
		return tsmpFuncList.stream().filter(this::isInEnterpriseLiteList).collect(Collectors.toList());
	}

	private List<TsmpFuncVo> getExpress() {
		return tsmpFuncList.stream().filter(this::isInExpressList).collect(Collectors.toList());
	}
